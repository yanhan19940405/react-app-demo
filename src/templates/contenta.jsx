...
class Appindex2 extends React.Component {
...
class Appbutton2 extends React.Component {
constructor () {
    super()
    this.state = {
      user: "",
...
.catch(function(err){
  ...
  render () {
    return (
      ...
      <Button type="dashed" icon="search" className="btn-btn" ref="btnaction"  id="btn1" onClick={this.handleClick.bind(this)}>复杂搜索</Button>
      </div>
      <div id="contain">
